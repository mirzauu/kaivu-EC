...
export const menu: MenuItem[] = [
  ...
  { id: "golden-fries", name: "Golden Fries", desc: "Hand-cut, sea salt, rosemary", price: 120, image: fries, category: "Side", rating: 4.6 },
  { id: "choco-shake", name: "Choco Velvet Shake", desc: "Belgian chocolate, whipped cream", price: 150, image: shake, category: "Drink", rating: 4.8 },
];
